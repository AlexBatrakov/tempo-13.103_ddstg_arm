...
1022      format('M2',f24.6,a,f20.6)
 ...
 2150    format('KIN',f23.3,a,f20.3)
      ...
      if(nbin.eq.17)write (71,2200) 'ALPHA0',alpha0                     !DDSTG print parameter alpha0
      if(nbin.eq.17)write (71,2200) 'BETA0 ',beta0                      !DDSTG print parameter beta0
      if(nbin.eq.17)write(71,'(''EOS'',17x,a)')eosname                  !DDSTG print parameter eosname
      if(nbin.eq.17)write(71,'(''COMP_TYPE'',11x,a)')companion_type     !DDSTG print parameter companion_type
      if(nbin.eq.17)write (71,2200) 'MA    ',mA 
      if(nbin.eq.17)write (71,2200) 'ALPHAA',alphaA                     
      if(nbin.eq.17)write (71,2200) 'BETAA ',betaA  
      if(nbin.eq.17)write (71,2200) 'kA    ',kA                         
      if(nbin.eq.17)write (71,2200) 'MB    ',mB 
      if(nbin.eq.17)write (71,2200) 'ALPHAB',alphaB                     
      if(nbin.eq.17)write (71,2200) 'BETAB ',betaB  
      if(nbin.eq.17)write (71,2200) 'kB    ',kB 
      if (.false.) then
      if(nbin.eq.17)write (71,2201) 'PBDOT       ',pbdot
      if(nbin.eq.17)write (71,2201) 'PBDOT_GR    ',pbdot_old
      if(nbin.eq.17)write (71,2201) 'PBDOT_D     ',pbdot_d
      if(nbin.eq.17)write (71,2201) 'DGAMMA_DM   ',dgamma_dm
      if(nbin.eq.17)write (71,2201) 'DGAMMA_DM_A ',dgamma_dm_ap  
      if(nbin.eq.17)write (71,2201) 'DGAMMA_DM2  ',dgamma_dm2    
      if(nbin.eq.17)write (71,2201) 'DGAMMA_DM2_A',dgamma_dm2_ap  
      if(nbin.eq.17)write (71,2201) 'DGAMMA_DM_F ',dgamma_dm_factor 
      if(nbin.eq.17)write (71,2201) 'DK_DM       ',dk_dm
      if(nbin.eq.17)write (71,2201) 'DK_DM_A     ',dk_dm_ap  
      if(nbin.eq.17)write (71,2201) 'DK_DM2      ',dk_dm2    
      if(nbin.eq.17)write (71,2201) 'DK_DM2_A    ',dk_dm2_ap  
      if(nbin.eq.17)write (71,2201) 'DK_DM_F     ',dk_dm_factor
      if(nbin.eq.17)write (71,2201) 'DSINI_DM    ',dsi_dm  
      if(nbin.eq.17)write (71,2201) 'DSINI_DM_A  ',dsi_dm_ap
      if(nbin.eq.17)write (71,2201) 'DSINI_DM2   ',dsi_dm2
      if(nbin.eq.17)write (71,2201) 'DSINI_DM2_A ',dsi_dm2_ap
      if(nbin.eq.17)write (71,2201) 'DSINI_DM_F  ',dsi_dm_factor       
      if(nbin.eq.17)write (71,2201) 'DDR_DM      ',ddr_dm
      if(nbin.eq.17)write (71,2201) 'DDR_DM_A    ',ddr_dm_ap
      if(nbin.eq.17)write (71,2201) 'DDR_DM2     ',ddr_dm2
      if(nbin.eq.17)write (71,2201) 'DDR_DM2_A   ',ddr_dm2_ap  
      if(nbin.eq.17)write (71,2201) 'DDR_DM_F    ',ddr_dm_factor   
      if(nbin.eq.17)write (71,2201) 'DDTH_DM     ',ddth_dm
      if(nbin.eq.17)write (71,2201) 'DDTH_DM_A   ',ddth_dm_ap
      if(nbin.eq.17)write (71,2201) 'DDTH_DM2    ',ddth_dm2
      if(nbin.eq.17)write (71,2201) 'DDTH_DM2_A  ',ddth_dm2_ap  
      if(nbin.eq.17)write (71,2201) 'DDTH_DM_F   ',ddth_dm_factor      
      if(nbin.eq.17)write (71,2201) 'DPBDOT_DM   ',dpbdot_dm      
      if(nbin.eq.17)write (71,2201) 'DPBDOT_DM_A ',dpbdot_dm_ap
      if(nbin.eq.17)write (71,2201) 'DPBDOT_DM2  ',dpbdot_dm2
      if(nbin.eq.17)write (71,2201) 'DPBDOT_DM2_A',dpbdot_dm2_ap  
      if(nbin.eq.17)write (71,2201) 'DPBDOT_DM_F ',dpbdot_dm_factor  
      endif              
      if(bp.ne.0.)  write (71,2200) 'BP    ',bp
      if(bpp.ne.0.) write (71,2200) 'BPP   ',bpp
 2200 format(a6,f20.7)
 2201 format(a12,e20.7)
